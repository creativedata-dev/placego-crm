  ...
  return (
    <SidebarProvider>
      ...
      <main className="flex-1 flex flex-col min-h-screen min-w-0 overflow-x-hidden">
        ...
        <header suppressHydrationWarning className="fixed top-0 left-0 right-0 z-40 border-b px-3 py-2.5 flex items-center gap-3 [background-color:#003762] sm:static sm:[background-color:unset] sm:bg-background sm:border-b sm:px-4 sm:py-3">
        ...
        <div className="flex-1 p-3 pt-16 sm:pt-3 sm:p-6 min-w-0">{children}</div>
      </main>
    </SidebarProvider>
  );
}
